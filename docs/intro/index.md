...
After this brief introduction to the EDA UI you are ready to start exploring the next generation of network automation by either starting ["The tour of EDA"](./declarative-intents.md) that we have prepared for you, or venturing into self-paced exploration.
